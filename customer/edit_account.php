		...
		<form action="" method="post" align="center" enctype="multipart/form-data">
					...
					<table align="center" width="750">
						...
						<tr align="center">
							<td colspan="6" style="color:#A9A9A9;"><h2>Update your Account</h2></td>
						</tr>
						<br>
						<tr>
							<td align="right" style="color:#2F4F4F;" >Customer Name:</td>
							<td><input type="text" name="c_name" value="<?php echo $name;?>" required/></td>
						</tr>
						
						<tr>
							<td align="right" style="color:#2F4F4F;">Customer Email:</td>
							<td><input type="text" name="c_email" value="<?php echo $email;?>" required/></td>
						</tr>
						
						<tr>
							<td align="right" style="color:#2F4F4F;">Customer Password:</td>
						...
						<tr>
							<td align="right" style="color:#2F4F4F;">Customer Country:</td>
							<td>
						...
						<tr>
							<td align="right" style="color:#2F4F4F;">Customer City:</td>
							<td><input type="text" name="c_city" value="<?php echo $city;?>"/></td>
						</tr>
						
						<tr>
							<td align="right" style="color:#2F4F4F;">Customer Contact:</td>
							<td><input type="text" name="c_contact" value="<?php echo $contact;?>"/></td>
						</tr>
						
						<tr>
							<td align="right" style="color:#2F4F4F;">Customer Address</td>
							<td><input type="text" name="c_address" value="<?php echo $address;?>"/></td>
						</tr>
						
						
					<tr align="center">
						<td colspan="6"><input type="submit"  class="btn btn-outline-secondary" name="update" value="Update Account" /></td>
					</tr>
