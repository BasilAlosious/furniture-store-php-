			...
			echo "
					<div id='single_product'>
						...
						<div class='card-header bg-transparent border-dark'>$pro_title</div>
	  					<img src='Admin_panel/product_images/$pro_image' class='card-img-top' alt='image not loading'>
	  					<div class='card-body'>
	    				<p class='card-text'> Price: ₹ $pro_price</p>
	    				<div class='card-footer bg-transparent border-dark'>
	    				<a href='details.php?pro_id=$pro_id' class='btn btn-outline-dark'>Details</a>
						<a href='shop.php?add_cart=$pro_id' class='btn btn-outline-dark' onclick='click_addcart()'>Add to cart</a>
					 </div>
	 				 </div>
					</div>
					</div>
		 ...
		 while($row_cat_pro=mysqli_fetch_array($run_cat_pro)){
			...
			echo "
					<div id='single_product'>
						...
						<div class='card-group'>
						<div class='card text-dark border-dark bg-transparent mb-3' style='width: 18rem;'>
						<div class='card-header bg-transparent border-dark'>$pro_title</div>
	  					<img src='Admin_panel/product_images/$pro_image' class='card-img-top' alt='image not loading'>
	  					<div class='card-body'>
	    				<p class='card-text'> Price: ₹ $pro_price</p>
